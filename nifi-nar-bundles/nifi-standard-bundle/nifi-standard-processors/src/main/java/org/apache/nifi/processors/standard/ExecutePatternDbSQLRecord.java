...
public class ExecutePatternDbSQLRecord extends AbstractExecutePatternDbSQL {
    ...
    public ExecutePatternDbSQLRecord() {
        ...
        pds.add(DB_URL_PARAMS);
        pds.add(DB_DRIVERNAME);
        pds.add(DB_DRIVER_LOCATION);
        pds.add(KERBEROS_CREDENTIALS_SERVICE);
        pds.add(DB_USER);
        pds.add(DB_PASSWORD);
        pds.add(MAX_WAIT_TIME);
        pds.add(MAX_TOTAL_CONNECTIONS);
        pds.add(VALIDATION_QUERY);
        pds.add(MIN_IDLE);
        pds.add(MAX_IDLE);
        pds.add(MAX_CONN_LIFETIME);
        pds.add(EVICTION_RUN_PERIOD);
        pds.add(MIN_EVICTABLE_IDLE_TIME);
        pds.add(SOFT_MIN_EVICTABLE_IDLE_TIME);
